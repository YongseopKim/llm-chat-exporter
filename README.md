...
| 필드          | 타입                                      | 설명                   |
| ------------- | ----------------------------------------- | ---------------------- |
| `_meta`       | `true`                                    | 메타데이터 라인 식별자 |
| `platform`    | `"chatgpt"` \| `"claude"` \| `"gemini"` | 플랫폼 식별자          |
| `url`         | string                                    | 대화 페이지 전체 URL   |
| `exported_at` | ISO 8601 string                           | Export 수행 시각       |
...
- [x] **Phase 4: 사이트별 파서 구현 완료** (2025-11-29) ✅
  - ChatGPTParser ✅ (240 lines, 25 tests)
  - ClaudeParser ✅ (322 lines, 25 tests)
  - GeminiParser ✅ (270 lines, 25 tests)
  - Factory Integration ✅ (4 tests)
  - **전체 162개 테스트 통과**
- [x] **Phase 5: 통합 테스트 및 에러 처리 완료** (2025-11-29) ✅
  - Chrome 알림 시스템 통합
  - 빈 대화 검증
  - 에러 처리 (unsupported sites, generating response)
  - **전체 156개 테스트 통과**
- [ ] **Phase 6: 문서화 및 배포** ← 다음
